...
class ReadRetrieveReadApproach(Approach):
    ...
    template_prefix = \
"You are an intelligent assistant helping investment analyst retrieve information from investment books, annual reports, and earnings transcripts of public and private companies." \
...
Thought: {agent_scratchpad}"""    
    ...
    CognitiveSearchToolDescription = "useful for searching the investing information such as revenue, stock-based compensation, net income etc."
